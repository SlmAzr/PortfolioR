    ...
    <section id="about" className="py-12 text-[#dce2f0]">
      ...
      <div className="max-w-3xl mx-auto px-4">
        <div className="space-y-4">
          <p className="text-lg">
            Bonjour, je m'appelle Salem, et je suis passionné par le développement web. Depuis que j'ai découvert la
            programmation, j'ai toujours eu envie de créer de nouvelles choses. J'aime relever des défis techniques et
            expérimenter avec de nouvelles technologies pour construire des applications et des sites qui apportent de
            la valeur.
          </p>
          <p className="text-lg">
